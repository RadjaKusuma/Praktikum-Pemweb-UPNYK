document.addEventListener('DOMContentLoaded', () => {
    ...
    // KEMBALI SEPERTI AWAL: Data awal didefinisikan di sini
    const initialStudents = [
        { nim: '123240001', nama: 'Ahmad Sahroni', jenisKelamin: 'Laki-Laki' },
        { nim: '123240099', nama: 'Puan Maharani', jenisKelamin: 'Perempuan' },
        { nim: '123240259', nama: 'Gibran Rakabuming', jenisKelamin: 'Laki-Laki' }
    ];

    // KEMBALI SEPERTI AWAL: Logika inisialisasi menggunakan variabel di atas
